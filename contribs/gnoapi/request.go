...
func makeRequest(log *slog.Logger, req Request) (res *abci.ResponseQuery, err error) {
...
func makeRender(logger *slog.Logger, rlmpath string) ([]byte, error) {
	var req Request
...
func makeFuncs(logger *slog.Logger, rlmpath string) (vm.FunctionSignatures, error) {
	var req Request
	req.RemoteAddr = remoteAddr
...
// func makeCall(logger *slog.Logger, makecfg makeCallCfg) ([]byte, error) {
// 	var cfg callCfg
