...
func TestTelemetry(t *testing.T) {
	...
	WithOptions(
		...
		//
		// `gopls/bug
		// github.com/gnolang/gno/contribs/gnopls/internal/util/bug.report:+35
		// github.com/gnolang/gno/contribs/gnopls/internal/util/bug.Report:=68
		// github.com/gnolang/gno/contribs/gnopls/internal/telemetry_test.TestTelemetry.func2:+4
		// github.com/gnolang/gno/contribs/gnopls/internal/test/integration.(*Runner).Run.func1:+87
		// testing.tRunner:+150
		// runtime.goexit:+0`
		//
