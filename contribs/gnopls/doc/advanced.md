...
```sh
$ go install github.com/gnolang/gno/contribs/gnopls@vX.Y.Z
```
...
go get -d github.com/gnolang/gno/contribs/gnopls@master golang.org/x/tools@master

go install github.com/gnolang/gno/contribs/gnopls
```
